  ...
  <body>
    ...
    <div class="container">
      ...
      <form id="frm" action="${pageContext.request.contextPath}/login2" method="post" class="form-signin">
        ...
        <input type="text" id="userId"  name="user_id" class="form-control" placeholder="userId" required>
        
        <label for="inputPassword" class="sr-only">Password</label>
        
        <input type="password" id="password"  name="user_pass" class="form-control" placeholder="Password" required>
