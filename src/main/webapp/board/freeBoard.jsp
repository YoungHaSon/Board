			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="row">
					<div class="col-sm-8 blog-main">
						...
						<div class="table-responsive">
							<table class="table table-striped">
								...
								<c:forEach items="${allText }" var="text">
									<!-- data-는 참고로 대문자 안먹어요 -->
									<tr class="userTr" data-userid="${text.text_id} }">
										<td>${text.userId }</td>
										<td>${text.name }</td>
										<td>${text.alias }</td>
										<td></td>
						...
						<a href="${pageContext.request.contextPath}/createText?board_id=${board_id}"class="btn btn-default pull-right">게시물 등록</a>
						...
						<div class="text-center">
							<ul class="pagination">
								...
								<c:choose>
									...
									<c:otherwise>
										<li><a
											href=" ${pageContext.request.contextPath }/primaryBoard?page=${pageVo.page-1}&pageSize=${pageVo.pageSize}">«</a>
										</li>
									</c:otherwise>
								</c:choose>
								...
								<c:forEach var="i" begin="1" end="${paginationSize }">
									<c:choose>
										...
										<c:otherwise>
											<li><a
												href="${pageContext.request.contextPath }/primaryBoard?page=${i}&pageSize=${pageVo.pageSize}">${i}</a>
											</li>
										</c:otherwise>
									</c:choose>
								</c:forEach>
